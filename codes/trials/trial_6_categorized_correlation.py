"""
Data Source: Yahoo Finance NSE data

Purpose: Stock Correlation Analysis with Categories
Input: NSE stock price data
Output:
- stock_correlation_matrix.csv: Complete correlation matrix
- categorized_correlations.csv: Categorized correlations
- correlation_heatmap.png: Visual correlation map
- top_correlations.csv: Top 20 correlations
"""
