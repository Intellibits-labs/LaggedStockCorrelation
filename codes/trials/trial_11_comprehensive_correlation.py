...
Data Source:
- stocks.csv (local file)
- Original data from Yahoo Finance NSE listings

Purpose: Comprehensive Stock Correlation Analysis with Multiple Outputs
Input:
- stocks.csv containing NSE stock price data
- max_lag values: 20, 60, 120 days
...
2. categorized_correlations.csv - Correlations categorized as:
   - Positive (> 0.5)
   - Negative (< -0.5)
   - No Correlation (between -0.5 and 0.5)
3. correlation_heatmap.png - Visual heatmap of correlations
4. top_correlations.csv - Top 20 correlated pairs
5. Individual correlation plots for top pairs

Description:
- Enhanced version of exp.py with additional analysis
- Includes correlation matrix generation
- Provides correlation categorization
- Creates comprehensive visualizations
- Removes self-correlations from heatmap
"""
