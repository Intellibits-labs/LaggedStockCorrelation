...
Purpose: Comprehensive Correlation Visualization
Input: NSE stock price data
Output:
- stock_correlation_matrix.csv: Correlation matrix
- correlation_heatmap.png: Visual heatmap
- lag_correlation_scatter.png: Lag analysis
- top_correlations.png: Top 20 correlations bar chart
"""
