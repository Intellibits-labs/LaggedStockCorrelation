"""
Data Source: Yahoo Finance API direct feed

Purpose: Rolling Window Correlation Analysis
Input: Stock price data for NSE stocks
Output:
- stock_correlation_matrix.csv: Complete correlation analysis
- categorized_correlations.csv: Categorized stock relationships
- correlation_heatmap.png: Visual correlation map
- top_correlation_scatter.png: Top pairs visualization
- rolling_correlation.csv: 30-day rolling correlations
"""
