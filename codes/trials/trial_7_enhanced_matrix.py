...
Purpose: Enhanced Stock Correlation Analysis
Input: NSE stock price data
Output:
- stock_correlation_matrix.csv: Matrix with NaN diagonals
- categorized_correlations.csv: Categorized relationships
