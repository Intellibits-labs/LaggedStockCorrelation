...
Purpose: Basic Stock Correlation Analysis with Lag Visualization
Input: 
- stocks.csv containing NSE stock price data
- max_lag values: 20, 60, 120 days

Output: 
- {stock_a}_{stock_b}_correlation_plot.png for top 20 correlated pairs
- Visual plots showing correlation vs lag relationships

Description:
- Calculates lagged correlations between all stock pairs
- Identifies top 20 correlated stock pairs
- Generates correlation vs lag plots for different time windows
- Supports multiple lag period analysis (20, 60, 120 days)
"""
