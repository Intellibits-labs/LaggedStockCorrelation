"""
Data Source: 
- stocks.csv from Outputs/csv directory
- Original data: Yahoo Finance NSE listings

Purpose: Sector-wise Stock Correlation Analysis
Input: NSE stock price data organized by sectors (75 stocks across 10 sectors)
Output: 
- {sector}_lagged_correlation.csv: Correlation data for each sector
- {sector}_lagged_correlation_heatmap.png: Visual correlation maps
"""
